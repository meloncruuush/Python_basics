# Scrivi una funzione a cui passerai come parametro una stringa, e che manderà in print una versione inversa
# della stessa stringa (ad esempio "abcd" diventerà "dcba")

def reverser(stringa):
    reverse = stringa[::-1]
    # il primo parametro è il valore da cui partire, il secondo quello a cui arrivare,
    # il terzo ogni quanto saltare
